...
public class EstagiarioController {
	...
	public String paginaInicial(Model model, HttpSession session) {
		...
		List<Turma> turmasComPresencaHoje  = turmaService.getTurmasComFrequenciaHoje(estagiario.getId());
		List<Turma> turmasSemPresencaHoje  = turmaService.getTurmasSemFrequenciaHoje(estagiario.getId());
		...
		model.addAttribute("turmasComPresencaHoje", turmasComPresencaHoje);
		model.addAttribute("turmasSemPresencaHoje", turmasSemPresencaHoje);
