 ...
 */
	...
	@Override
	public List<Turma> getTurmasComFrequenciaHoje(Long idEstagiario) {
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("idEstagiario", idEstagiario);
		List<Turma> turmas =  find(QueryType.JPQL, "select t from Turma t join t.frequencias f where :idEstagiario member of t.estagiarios and :idEstagiario = f.estagiario.id and f.data = CURRENT_DATE", params);
		return turmas;
	}
